...
ChatBot::~ChatBot() {
    std::cout << "ChatBot destory" << std::endl;
}

std::string ChatBot::getChatResponse(const std::string& question, const std::string& model) {
        CURL* curl;
        CURLcode res;
        ...
        if (curl) {
            ...
            std::string apiKey = "sk-BfA7P22Hyf92cjmcHOrouMcL0bn0Ze8dYz9mlOdt5cRjxj6K"; 
